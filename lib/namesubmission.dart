            ...
            : Column(
              ...
              children: [SizedBox(height: screenHeight*0.2,),
                Text(
                  ...
                  style: TextStyle(
                      fontSize: screenWidth * 0.06,color:  const Color.fromRGBO(4, 41, 35, 1),
                ...
                Text(
                  ...
                  style: TextStyle(
                      fontSize: screenWidth * 0.05, color: Color.fromRGBO(112, 112, 112, 1)),
                ),
                SizedBox(height: screenWidth * 0.05),
                TextField(maxLines: 1,maxLength: 15,
                ...
                Padding(
                  ...
                  child: const Divider(thickness: 10, color: Color.fromRGBO(219, 219, 219, 1)),
                ),
